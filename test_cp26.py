...
def test_crear_curso_estando_logueado(driver):
    ...
    driver.find_element(By.ID, "course-id").send_keys("CS2024-S1")
    driver.find_element(By.ID, "course-name").send_keys(" ")
    
    # Captura de entrada
    driver.save_screenshot("capturas/entradas/CP26_entrada.png")
    print("Captura tomada: capturas/entradas/CP26_entrada.png")
    ...
    # Captura de salida
    driver.save_screenshot("capturas/salidas/CP26_salida.png")
    print("Captura tomada: capturas/salidas/CP26_salida.png")