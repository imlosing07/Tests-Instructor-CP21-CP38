...
def test_crear_curso_estando_logueado(driver):
    ...
    driver.find_element(By.ID, "course-id").send_keys("CS2024-AUTO-1")
    driver.find_element(By.ID, "course-name").send_keys("Test Auto TimeZone Course")
    
    # Captura de entrada
    driver.save_screenshot("capturas/entradas/CP23_entrada.png")
    print("Captura tomada: capturas/entradas/CP23_entrada.png")
    ...
    # Captura de salida
    driver.save_screenshot("capturas/salidas/CP23_salida.png")
    print("Captura tomada: capturas/salidas/CP23_salida.png")