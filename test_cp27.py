...
def test_crear_curso_estando_logueado(driver):
    ...
    driver.find_element(By.ID, "course-id").send_keys("B")
    driver.find_element(By.ID, "course-name").send_keys("Software Testing 2025")
    
    # Captura de entrada
    driver.save_screenshot("capturas/entradas/CP27_entrada.png")
    print("Captura tomada: capturas/entradas/CP27_entrada.png")
    ...
    # Captura de salida
    driver.save_screenshot("capturas/salidas/CP27_salida.png")
    print("Captura tomada: capturas/salidas/CP27_salida.png")