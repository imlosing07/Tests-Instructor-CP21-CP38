...
def test_crear_curso_estando_logueado(driver):
    ...
    # Captura de entrada
    driver.save_screenshot("capturas/entradas/CP21_entrada.png")
    print("Captura tomada: capturas/entradas/CP21_entrada.png")
    ...
    # Captura de salida
    driver.save_screenshot("capturas/salidas/CP21_salida.png")
    print("Captura tomada: capturas/salidas/CP21_salida.png")