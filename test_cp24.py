...
def test_crear_curso_estando_logueado(driver):
    ...
    driver.find_element(By.ID, "course-id").send_keys("%1232")
    driver.find_element(By.ID, "course-name").send_keys("Test Special Chars")
    
    # Captura de entrada
    driver.save_screenshot("capturas/entradas/CP24_entrada.png")
    print("Captura tomada: capturas/entradas/CP24_entrada.png")
    ...
    # Captura de salida
    driver.save_screenshot("capturas/salidas/CP24_salida.png")
    print("Captura tomada: capturas/salidas/CP24_salida.png")