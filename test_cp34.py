...
def test_cp34_buscar_estudiante_por_nombre(driver):
    print("\n========== CASO DE PRUEBA: CP34 - Buscar estudiante por nombre ==========\n")
    ...
    search_input.click()
    search_input.send_keys("Alice Betsy")
    time.sleep(1)
    print("3. Se ingresó el nombre a buscar: 'Alice Betsy'.")

    # Captura de la entrada
    driver.save_screenshot("capturas/entradas/CP34_entrada.png")
    ...
    driver.save_screenshot("capturas/salidas/CP34__salida.png")
    print("✓ Captura tomada: resultado de búsqueda almacenado.")
    
    print("\n✅ Resultado: Estudiante 'Alice Betsy' buscado exitosamente.\n")