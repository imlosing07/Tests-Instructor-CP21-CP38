...
def test_crear_curso_estando_logueado(driver):
    ...
    driver.find_element(By.ID, "course-id").send_keys("CS2024-S2")
    driver.find_element(By.ID, "course-name").send_keys("Software Engineering II")
    
    # Captura de entrada
    driver.save_screenshot("capturas/entradas/CP22_entrada.png")
    print("Captura tomada: capturas/entradas/CP22_entrada.png")
    ...
    # Captura de salida
    driver.save_screenshot("capturas/salidas/CP22_salida.png")
    print("Captura tomada: capturas/salidas/CP22_salida.png")