...
def test_cp34_buscar_estudiante_por_nombre(driver):
    print("\n========== CASO DE PRUEBA: CP36 - Buscar por seccion ==========\n")
    ...
    search_input.click()
    search_input.send_keys("Tutorial Group 1")
    time.sleep(1)
    print("3. Se ingresó el correo a buscar: 'Tutorial Group 1'.")

    # Captura de la entrada
    driver.save_screenshot("capturas/entradas/CP36_entrada.png")
    ...
    driver.save_screenshot("capturas/salidas/CP36_salida.png")
    print("✓ Captura tomada: resultado de búsqueda almacenado.")
    
    print("\n✅ Resultado: Seccion 'Tutorial Group 1' buscado exitosamente.\n")